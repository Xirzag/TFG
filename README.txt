Este trabajo trata sobre las diferentes tecnicas esteroscópicas y su implementación en OpenGL. El programa de OpenGL esta diseñado para ejecutarse en Windows y proyectarse en un movil usando algún programa como SpaceDesk. A su vez también se desarrollo una aplicación llamada SensorTransmitter que trasmite la orientación del dispositivo para que sea usada por el programa de OpenGL.
Esta implementación esta pensada para ser usada como entorno de pruebas o de aprendizaje y no en un producto final.
